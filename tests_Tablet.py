...
def driver():
    ...
    fire_fox_options.add_argument("--height=119464")
    fire_fox_options.set_preference("general.useragent.override", "userAgent=Mozilla/5.0 "
                                                                  "(iPad; CPU OS 14_7_1 like Mac OS X) AppleWebKit/605.1.15 "
...
def test_registration(driver):
    ...
    time.sleep(2)
    driver.find_element(By.CSS_SELECTOR, "button.wt-btn--secondary:nth-child(1)").click()
    time.sleep(5)
